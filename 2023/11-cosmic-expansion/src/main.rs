...
impl Chart {
    ...
    fn sum_distances_between_all_pairs_of_galaxies(&mut self) -> i32 {
        self.galaxy_pairs()
            .into_iter()
            .map(|(galaxy_1, galaxy_2): (Galaxy, Galaxy)| -> i32 {
                ...
                row.into_iter().enumerate().for_each(|(x_idx, tile)| {
                    if tile == "#" {
                        ...
                        galaxies.push(Galaxy {
                            ...
                            x: x_idx as i32 + padded_x as i32,
                            y: y_idx as i32 + padded_y as i32,
                        });
                    }
                });
            });
...
fn compute_distance_between_galaxy_pair(galaxy_1: Galaxy, galaxy_2: Galaxy) -> i32 {
...
#...#.....",
        ...
        chart.process_data();
        assert_eq!(chart.sum_distances_between_all_pairs_of_galaxies(), 374);
    }
}

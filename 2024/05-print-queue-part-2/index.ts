...
console.log(
	`Generated median sum of validated updates: ${generateMedianSumOfFilteredSafetyProtocols(
		safetyProtocols,
	)}`,
);
console.log(
	`Generated median sum of reordered invalid updates: ${generateMedianSumOfFilteredSafetyProtocols(
		safetyProtocols,
		true,
	)}`,
);
